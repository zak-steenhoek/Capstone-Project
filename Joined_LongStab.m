...
l1 = (np1- MAC2*0.20); % Distance from AC of Front Wing to cg
l2 = (np2-MAC2*0.20); % Distance from AC of aft wing to cg
q = 0.5*rho*V^2;
alpha0 = -6.82 * pi/180;
...
y = 0.00; ybar = y; % Height between wing aerodynamic center
