...
options = optimoptions('fmincon',Display="iter", Algorithm="interior-point", EnableFeasibilityMode=true, StepTolerance=1e-20, OptimalityTolerance=1e-20, ConstraintTolerance=1e-20); %  DiffMinChange=1e-3, ConstraintTolerance=1e-6,
% a = fmincon(@AircraftModel,a0,A,b,Aeq,beq,lb,ub,@nonlcon,options)
a = fmincon(@AircraftModel,a0,A,b,Aeq,beq,lb,ub,[],options)
