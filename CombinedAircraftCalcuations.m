...
figure
[figure2, aw2, cmc, cmt2, Cmf2, cm0wing2, cl_tot2, cd_tot2] = UAS2_LongStab(Lambdaw2, Wing2_halfSweep, ...
    wspan2, Wing2_S, df2,...
    CMAC2,-Wing2_AC(1,2), -NP2, Tail2_halfSweep, Tail2_quarterSweep, tspan2, Tail2_S,lt2);
figure
[figure3] = Joined_LongStab(Wing1_S, Wing2_S,wspan1,wspan2, CMAC1, CMAC2,...
    -Wing1_AC(1,2), -Wing2_AC(1,2), aw, aw2, cmt, cmc, cmt2, cm0wing, cm0wing2, Lambdaw2);
